...
@section('content')
    ...
    <div class="card table-responsive">
        <div class="card-header">
            ...
            <a class="btn btn-danger float-right" href="{{route('mecanicaoff.pdf')}}"><i class="fas fa-file-pdf"></i>{{ __(' Imprimir') }}</a>
        </div>
        <div class="card-body">
                ...
                <tbody>
                    @foreach ( $proyectos as $x )
                        <tr style='color:black; text-align:center'>
                            ...
                            @can('mecanicaoff.edit')
                                <td>
                                    <a class="btn" style="background-color: #1F5F96; color:white" href="{{route('mecanicaoff.edit',$x)}}">
