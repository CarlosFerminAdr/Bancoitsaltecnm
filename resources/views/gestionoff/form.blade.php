                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control is-valid" id="nombre" name="nombre"
                            placeholder="escriba un Nombre.." value="{{isset($gestionoff->proyectograma->nombre)?$gestionoff->proyectograma->nombre:old('nombre')}}" required readonly>
                    ...
                    <div class="col-md-8"><br>
                        ...
                        <input type="text" class="form-control is-valid" id="empresa" name="empresa"
                            placeholder="primer apelldo.." value="{{isset($gestionoff->proyectograma->empresa->nombre)?$gestionoff->proyectograma->empresa->nombre:old('nombre')}}" required readonly>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-2"><br>
                        ...
                        <input type="number" class="form-control is-valid" id="nalumnos" name="nalumnos" min="0" max="999"
                            placeholder="0.." value="{{isset($gestionoff->proyectograma->nalumnos)?$gestionoff->proyectograma->nalumnos:old('nalumnos')}}" required readonly>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-2"><br>
                        ...
                        <input type="date" class="form-control is-valid" id="flimite" name="flimite"
                            placeholder="primer apelldo.." value="{{isset($gestionoff->proyectograma->flimite)?$gestionoff->proyectograma->flimite:old('flimite')}}" required readonly>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-6"><br>
                        ...
                        <input type="text" class="form-control is-valid" id="carrera" name="carrera"
                            placeholder="primer apelldo.." value="{{isset($gestionoff->carrera->nombre)?$gestionoff->carrera->nombre:old('nombre')}}" required readonly>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-6"><br>
                        ...
                        <label class="mr-4">
                            ...
                            {{(isset($pe->id) && $pe->id == $gestionoff->periodo_id)?'checked':''}}>{{$pe->nombre}}
                        </label>
                        @endforeach
                    </div>
                    ...
                    <div class="col-md-6"><br>
                        ...
                        <textarea name="objetivo" id="objetivo" rows="3" class="form-control"
                            required readonly>{{isset($gestionoff->objetivo)?$gestionoff->objetivo:old('objetivo')}}</textarea>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-6"><br>
                        ...
                        <textarea name="problematica" id="problematica" rows="3" class="form-control"
                            required readonly>{{isset($gestionoff->problematica)?$gestionoff->problematica:old('problematica')}}</textarea>
                        <div class="invalid-feedback">
        ...
        <div class="card was-validated shadow border border-primary">
            ...
            <div class="card-body">
                ...
                <label class="mr-4">
                    ...
                    {{(isset($e->id) && $e->id == $gestionoff->status)?'checked':''}}>{{$e->tipo_status}}
                </label>
                @endforeach
            </div>
        </div>
...
@can('gestionoff.index')
    <a class="btn float-end mt-2" style="background-color: #1F5F96; color:white" href="{{route('gestionoff.index')}}">
