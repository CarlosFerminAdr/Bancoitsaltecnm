...
@section('content')
    @if (Session('mensaje') == 'Jefe de Departamento agregado corectamente!')
    ...
    @endif
    @if (Session('mensaje') == 'Jefe de Departamento actualizado corectamente!')
    ...
    @endif
    @if (Session('mensaje') == 'Jdepto eliminado corectamente!')
                ...
                <tbody>
                    @foreach ( $jdeptos as $d )
                        <tr style='color:black; text-align:center'>
                            ...
                            @can('jdeptos.edit')
                                <td>
                                    <a class="btn btn-warning" href="{{route('jdeptos.edit',$d)}}">
