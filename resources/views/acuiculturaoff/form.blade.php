                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control is-valid" id="nombre" name="nombre"
                            placeholder="escriba un Nombre.." value="{{isset($acuiculturaoff->proyectograma->nombre)?$acuiculturaoff->proyectograma->nombre:old('nombre')}}" required readonly>
                    ...
                    <div class="col-md-8"><br>
                        ...
                        <input type="text" class="form-control is-valid" id="empresa" name="empresa"
                            placeholder="primer apelldo.." value="{{isset($acuiculturaoff->proyectograma->empresa->nombre)?$acuiculturaoff->proyectograma->empresa->nombre:old('nombre')}}" required readonly>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-2"><br>
                        ...
                        <input type="number" class="form-control is-valid" id="nalumnos" name="nalumnos" min="0" max="999"
                            placeholder="0.." value="{{isset($acuiculturaoff->proyectograma->nalumnos)?$acuiculturaoff->proyectograma->nalumnos:old('nalumnos')}}" required readonly>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-2"><br>
                        ...
                        <input type="date" class="form-control is-valid" id="flimite" name="flimite"
                            placeholder="primer apelldo.." value="{{isset($acuiculturaoff->proyectograma->flimite)?$acuiculturaoff->proyectograma->flimite:old('flimite')}}" required readonly>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-6"><br>
                        ...
                        <input type="text" class="form-control is-valid" id="carrera" name="carrera"
                            placeholder="primer apelldo.." value="{{isset($acuiculturaoff->carrera->nombre)?$acuiculturaoff->carrera->nombre:old('nombre')}}" required readonly>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-6"><br>
                        ...
                        <label class="mr-4">
                            ...
                            {{(isset($pe->id) && $pe->id == $acuiculturaoff->periodo_id)?'checked':''}}>{{$pe->nombre}}
                        </label>
                        @endforeach
                    </div>
                    ...
                    <div class="col-md-6"><br>
                        ...
                        <textarea name="objetivo" id="objetivo" rows="3" class="form-control"
                            required readonly>{{isset($acuiculturaoff->objetivo)?$acuiculturaoff->objetivo:old('objetivo')}}</textarea>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-6"><br>
                        ...
                        <textarea name="problematica" id="problematica" rows="3" class="form-control"
                            required readonly>{{isset($acuiculturaoff->problematica)?$acuiculturaoff->problematica:old('problematica')}}</textarea>
                        <div class="invalid-feedback">
        ...
        <div class="card was-validated shadow border border-primary">
            ...
            <div class="card-body">
                ...
                <label class="mr-4">
                    ...
                    {{(isset($e->id) && $e->id == $acuiculturaoff->status)?'checked':''}}>{{$e->tipo_status}}
                </label>
                @endforeach
            </div>
        </div>
...
@can('acuiculturaoff.index')
    <a class="btn float-end mt-2" style="background-color: #1F5F96; color:white" href="{{route('acuiculturaoff.index')}}">
