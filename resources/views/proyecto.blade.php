    ...
    <div class="container">
        ...
        <section id="titulo">
            <div class="text-center text-white">
                <h3>SISTEMA DE GESTIÓN DE BANCOS DE PROYECTOS RECIDENCIA PROFECIONAL</h3>
            </div>
        </section>
        <div class="itsal">
                ...
                <div class="modal-body">
                    <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                @if (isset($sql1))
                                    @foreach ( $sql1 as $a )
                                        <input type="text" class="form-control" id="apaterno" name="apaterno" value="{{$sql1->apaterno}}">
                                    @endforeach
                                @else
                            ...
                            <div class="col-md-6">
                                ...
                                @if (isset($sql1))
                                    @foreach ( $sql1 as $a )
                                        <input type="text" class="form-control" id="amaterno" name="amaterno" value="{{$a->amaterno}}">
                                    @endforeach
                                @else
                            ...
                            <div class="col-md-6"><br>
                                ...
                                @if (isset($sql1))
                                    @foreach ( $sql1 as $a )
                                        <input type="text" class="form-control" id="nombre" name="nombre" value="{{$a->nombre}}">
                                    @endforeach
                                @else
                            ...
                            <div class="col-md-6"><br>
                                ...
                                @if (isset($sql1))
                                    @foreach ( $sql1 as $a )
                                        <input type="text" class="form-control" id="carrerra" name="carrerra" value="{{$a->carrera->nombre}}">
                                    @endforeach
                                @else
