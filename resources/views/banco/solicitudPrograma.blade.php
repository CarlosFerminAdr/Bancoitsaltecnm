...
@section('title', 'Solicitud Programa')

@section('content_header')
    <h1>SOLICITUD DE PROGRAMA</h1>
@stop
...
@section('content')
    ...
    @endif
    <form id="form" action="{{route('solicitudPrograma.store')}}" method="POST" autocomplete="off">
        @csrf
        <div class="row">
            <div class="col-sm-12 mb-3">
                <div class="card shadow border border-primary">
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <label for="proyecto" class="form-label">Programa:</label>
                                <input type="text"class="form-control" id="proyecto" value="{{$programa->proyectograma->nombre}}" readonly>
                            </div>
                            <div class="col-md-8"><br>
                                <label for="proyecto" class="form-label">Empresa:</label>
                                <input type="text"class="form-control" id="proyecto" value="{{$programa->proyectograma->empresa->nombre}}" readonly>
                            </div>
                            <div class="col-md-2"><br>
                                <label for="proyecto" class="form-label">Fecha Limite:</label>
                                <input type="text"class="form-control" id="proyecto" value="{{$programa->proyectograma->flimite}}" readonly>
                            </div>
                            <div class="col-md-2"><br>
                                <label for="proyecto" class="form-label">No Alumnos:</label>
                                <input type="text"class="form-control" id="proyecto" name="nalumnos" value="{{$programa->proyectograma->nalumnos}}" readonly>
                            </div>
                            <div class="col-md-8"><br>
                                <label for="proyecto" class="form-label">Carrera:</label>
                                <input type="text"class="form-control" id="proyecto" value="{{$programa->carrera->nombre}}" readonly>
                            </div>
                            <div class="col-md-4"><br>
                                <label for="proyecto" class="form-label">Periodo:</label>
                                <input type="text"class="form-control" id="proyecto" value="{{$programa->periodo->nombre}}" readonly>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div>
            ...
            <a class="btn float-end mt-2" style="background-color: #1F5F96; color:white" href="{{route('home2')}}">
